...
1. 10953537(njoya-alex): Responsible for designing the user interface and user experience of the app.
...
2. 10953091(AsanteAsareIsaac10953091): Implemented the login and signup functionality of the app.
...
3. 10954418(victoriaakakpovie): Implemented the task management functionality of the app.
...
4. 10947903(mariepearl): Responsible for integrating the app with a backend database.
...
5. 10949743(nkbiney): Implemented the functionality to delete tasks from the app.
