...
10953537 and 10986196: Responsible for designing the user interface and user experience of the app.
...
10953091 and 10949743: Implemented the login and signup functionality of the app.
...
Worked on data validation and error handling for login and signup.
 ...
 (Task Management): Implemented the task management functionality of the app.
...
Collaborated with database team to ensure proper storage and retrieval of task data.
 ...
 (Database Integration): Responsible for integrating the app with a backend database.
...
Worked with the task management team to ensure proper data synchronization.
 ...
 (Task Deletion): Implemented the functionality to delete tasks from the app.
...
Ensured proper data handling and database synchronization upon task deletion.
 ...
 (Logout): Implemented the logout functionality of the app.
...
Collaborated with the authentication team to handle logout requests.
 ...
 (Testing and Quality Assurance): Responsible for testing and ensuring the quality of the app.
...
Collaborated with other team members to address any reported issues and improve app performance.
 ...
 (Documentation): Responsible for documenting the app and its features.
...
Ensured that the README file and any other necessary documentation were up to date.
 ...
 (Deployment): Responsible for deploying the app to the Google Play Store.
